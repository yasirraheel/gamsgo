...
<body class="bg-gray-900 text-white">
  ...
  <script type="text/babel" data-presets="env,react">
    ...
    const ProductsView = () => {
      ...
      return (
        <>
          <header className="min-h-16 bg-gray-800 border-b border-gray-700 flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 py-4 gap-3 flex-shrink-0">
            <div>
              <h1 className="text-lg sm:text-xl font-bold">Products Management</h1>
              <p className="text-xs sm:text-sm text-gray-400">Manage your product catalog</p>
            </div>
            <button onClick={openAddModal} className="w-full sm:w-auto px-4 py-2 bg-primary hover:bg-blue-600 rounded-lg text-sm transition-colors whitespace-nowrap">
